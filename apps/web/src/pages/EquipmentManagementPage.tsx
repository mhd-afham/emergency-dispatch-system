  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                UC-005 Digital Equipment Readiness System - Monitor vehicle
                readiness, manage equipment checks, and track maintenance status
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === "overview" && <SupervisorEquipmentSection />}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <h4 className="text-lg font-medium text-blue-900 mb-3">
                UC-005 Compliance Requirements
              </h4>
              <div className="space-y-2 text-sm text-blue-800">
                <div className="flex items-start">
                  <div className="text-blue-600 mr-2">✓</div>
                  <div>
                    Digital equipment readiness tracking with real-time status
                    updates
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="text-blue-600 mr-2">✓</div>
                  <div>
                    Automated maintenance workflow with supervisor approval
                    system
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="text-blue-600 mr-2">✓</div>
                  <div>
                    Equipment status classification: READY,
                    AVAILABLE_WITH_RESTRICTIONS, OUT_OF_SERVICE,
                    PENDING_INSPECTION
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="text-blue-600 mr-2">✓</div>
                  <div>
                    Manual maintenance record creation for issues not caught by
                    automated checks
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="text-blue-600 mr-2">✓</div>
                  <div>
                    Integration with vehicle dispatch system for equipment
                    availability
                  </div>
                </div>
              </div>
        ...
        {/* Search & Reports Tab */}
        {activeTab === "search" && <MaintenanceRecordSearch />}
      </div>
          ...
          <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div className="px-6 py-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-500">
                Manual maintenance logging as per UC-005
              </p>
            </div>
