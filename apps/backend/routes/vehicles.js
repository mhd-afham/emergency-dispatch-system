...
/**
 * Vehicle Registration Routes for Emergency Dispatch System
 ...
 * @access  Field Crew (assigned vehicles), Supervisors, Admins
 */
router.put('/:id/location', (req, res, next) => {
  const allowedRoles = ['Field Crew', 'Supervisor', 'Admin'];
