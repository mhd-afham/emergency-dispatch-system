          ...
          <div className="bg-white shadow rounded-lg">
            <div className="px-6 py-8 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">
                ...
                <br />
                Emergency call intake and incident logging functionality will be
                available soon.
              </p>
              <div className="mt-6">
                <div className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700">
                  <svg
